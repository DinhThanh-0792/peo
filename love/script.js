...
document.getElementById("siBtn").addEventListener("click", function () {
  ...
  document.getElementById("messageContainer").innerHTML =
    "Anh hông ngờ tới luôn đó, iu em lắm luônnn:3";
...
document.getElementById("noBtn").addEventListener("click", function () {
  switch (noButtonState) {
    ...
    case 5:
      document.getElementById("noBtn").innerHTML =
        "Em muốn bỏ rơi chàng trai này ư";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 10:
      document.getElementById("noBtn").innerHTML =
        "hãy chấp nhận tình iuu của anhh nhóo";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 11:
      document.getElementById("noBtn").innerHTML =
        "Anhh thật sự rất và rất iuu em đó";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 12:
      document.getElementById("noBtn").innerHTML =
        "Đừng bỏ rơi chàng trai đáng thương này mà";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
